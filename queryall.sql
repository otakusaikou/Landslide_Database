SELECT *
FROM (SELECT slide_id, project_name AS project, project_date, workingcircle_name, forest_name, county_name, town_name, reservoir_name, water_name, basin_name, area, centroid_x, centroid_y, geom
