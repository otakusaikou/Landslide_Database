--Delete old tables
DROP TABLE IF EXISTS slide_area;
...
DROP TABLE IF EXISTS working_circle;
CREATE TABLE working_circle
(
...
DROP TABLE IF EXISTS forest_district;
CREATE TABLE forest_district
(
...
DROP SEQUENCE IF EXISTS project_id_area_gid_seq;
CREATE SEQUENCE project_id_area_gid_seq START 1;
...
DROP SEQUENCE IF EXISTS slide_id_area_gid_seq;
CREATE SEQUENCE slide_id_area_gid_seq START 1; 
